<?php
    ...
    echo "<tr><td>" . htmlspecialchars($row['Username']) . "</td><td>" . htmlspecialchars($row['GallonsRequested']) . "</td><td>" . htmlspecialchars($str) ."</td><td>" . htmlspecialchars($row['PricePerGallon']) . "</td><td>" . htmlspecialchars($row['Total']) . "</td></tr>";  //$row['index'] the index here is a field name
    }
